...
import cst8218.alir0003.entity.SpriteFacade;
...
public class SpriteController implements Serializable {
    ...
    @EJB
    private cst8218.alir0003.entity.SpriteFacade ejbFacade;
    ...
    //SpriteColourConverter class 
    @XmlRootElement
    @XmlAccessorType(XmlAccessType.FIELD)
    @FacesConverter("color")
    //In this class we taking in the colour object that is passed in and turning into a string and the other way around 
    public static class SpriteColourConverter implements Converter {
        @Column
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            //Splits the array based off of ,
            String[] colours = value.split(",");
            Color colourCode = new Color(Integer.parseInt(colours[0]),Integer.parseInt(colours[1]),Integer.parseInt(colours[2]));
            System.out.println(value);
            //Retuns the colour code from the object
            return colourCode;
        }
        //In the getAsString class we takke the given colour obj value and return it as a string
        @Override
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            String colourVal = "";
            Color colour = (Color)object;
            colourVal += colour.getRed()+",";
            colourVal += colour.getGreen()+",";
            colourVal += colour.getBlue();
            return colourVal;
        }  
    }  
